...
GL/GLES/EGL/GLX/WGL Loader made for your needs. aufw-glloader currently supports
...
from glloader.spec import SPECS
import glloader.lang


Version = namedtuple('Version', ['major', 'minor'])

logger = logging.getLogger('glloader')
...
def main():
	...
	generator_cls, loader_cls = glloader.lang.get_generator(
